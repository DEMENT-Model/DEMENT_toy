...
class Grid():
    ...
    def metabolism(self,day):
        ...
        self.CUE_taxon = self.Microbes['C'].copy() # create a dataframe and set all vals to 0
        self.CUE_taxon[:] = 0        
        pos_uptake_index = self.Taxon_Uptake_C > 0
        self.CUE_taxon[pos_uptake_index] = Microbe_C_Gain[pos_uptake_index]/self.Taxon_Uptake_C[pos_uptake_index]
        #print(self.CUE_taxon)
        self.CUE_taxon = self.CUE_taxon[pos_uptake_index] # Gives the CUE for each taxon
        #print(self.CUE_taxon)
        ...
        #print((Microbe_C_Gain.tolist()))
        #print(self.Taxon_Uptake_C)
